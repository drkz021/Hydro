...
socket.on('fan_status', (arg) => {
    ...
    if (arg == 'ON') {
        ...
        document.getElementById("fanStatus").style.color = "#008111";
    } else {
        fanController.removeAttribute('Checked');
...
socket.on('light_status', (arg) => {
    if (arg == 'ON') {
        ...
        document.getElementById("lightStatus").style.color ="#008111";
    } else {
        lightController.removeAttribute('Checked');
        document.getElementById("lightStatus").innerHTML = "Off";
        document.getElementById("lightStatus").style.color = "#000000";
    }
...
socket.on('pump_status', (arg) => {
    if (arg == 'ON') {
        ...
        document.getElementById("pumpStatus").style.color ="#008111";
    } else {
        pumpController.removeAttribute('Checked');
        document.getElementById("pumpStatus").innerHTML = "Off";
        document.getElementById("pumpStatus").style.color = "#000000";
    }
...
socket.on('mist_status', (arg) => {
    if (arg == 'ON') {
        ...
        document.getElementById("mistStatus").innerHTML = "On";
        document.getElementById("mistStatus").style.color ="#008111";
    } else {
        mistController.removeAttribute('Checked');
        document.getElementById("mistStatus").innerHTML = "Off";
        document.getElementById("mistStatus").style.color = "#000000";
    }
...
socket.on('aero_status', (arg) => {
    if (arg == 'ON') {
        ...
        document.getElementById("aeroStatus").innerHTML = "On";
        document.getElementById("aeroStatus").style.color ="#008111";
    } else {
        aeratorController.removeAttribute('Checked');
        document.getElementById("aeroStatus").innerHTML = "Off";
        document.getElementById("aeroStatus").style.color = "#000000";
    }
...
socket.on('water_temp', (arg) => {
    ...
    if (arg<=27) {
        ...
        document.querySelector('.fa-temperature-half').style.color = '#48D1CC';
        document.getElementById("watertempStatus").innerHTML = "Normal";
        document.getElementById("watertempStatus").style.color ="#48D1CC";
    } else if (arg>27){
        water_tempValue.style.color = 'red';
        document.querySelector('.fa-temperature-half').style.color = 'red';
        document.getElementById("watertempStatus").innerHTML = " Not Normal";
        document.getElementById("watertempStatus").style.color ="red";
    }
   // console.log(arg)
});

socket.on('ph_value', (arg) => {
    ph_Value.innerHTML = arg + 'pH';
    if (arg<=5.49) {
        ph_Value.style.color = 'red';
        document.querySelector('.fa-thermometer').style.color = 'red';
        document.getElementById("phStatus").innerHTML = "Not Normal";
        document.getElementById("phStatus").style.color ="red";
    } else if (arg>5.49 && arg<6.49){
        ph_Value.style.color = '#48D1CC';
        document.querySelector('.fa-thermometer').style.color = '#48D1CC';
        document.getElementById("phStatus").innerHTML = "Normal";
        document.getElementById("phStatus").style.color ="#48D1CC";
    } else if (arg>=6.49){
        ph_Value.style.color = 'red';
        document.querySelector('.fa-thermometer').style.color = 'red';
        document.getElementById("phStatus").innerHTML = "Not Normal";
...
socket.on('ec_value', (arg) => {
    ec_Value.innerHTML = arg + 'mS/cm';
    if (arg<=0.79) {
        ec_Value.style.color = 'red';
        document.querySelector('.fa-vials').style.color = 'red';
        document.getElementById("ecStatus").innerHTML = "Not Normal";
        document.getElementById("ecStatus").style.color ="red";
    } else if (arg>0.79) {
        ec_Value.style.color = '#48D1CC';
        document.querySelector('.fa-vials').style.color = '#48D1CC';
        document.getElementById("ecStatus").innerHTML = "Normal";
        document.getElementById("ecStatus").style.color ="#48D1CC";
    }
   // console.log(arg)
});
...
socket.on('humid', (arg) => {
    ...
    if (arg<=50) {
        ...
        document.querySelector('.fa-wind').style.color = 'red';
        document.getElementById("humidStatus").innerHTML = "Not Normal";
        document.getElementById("humidStatus").style.color ="red";
    } else if (arg>50) {
        humid_Value.style.color = '#48D1CC';
        document.querySelector('.fa-wind').style.color = '#48D1CC';
        document.getElementById("humidStatus").innerHTML = "Normal";
        document.getElementById("humidStatus").style.color ="#48D1CC";
    }
   // console.log(arg)
});
...
socket.on('room_temp', (arg) => {
    ...
    if (arg<=27) {
        ...
        document.querySelector('.fa-temperature-high').style.color = '#48D1CC';
        document.getElementById("roomStatus").innerHTML = "Normal";
        document.getElementById("roomStatus").style.color ="#48D1CC";
    } else if (arg>27){
        room_tempValue.style.color = 'red';
        document.querySelector('.fa-temperature-high').style.color = 'red';
        document.getElementById("roomStatus").innerHTML = " Not Normal";
        document.getElementById("roomStatus").style.color ="red";
    }
  //  console.log(arg)
});
        ...
        form.addEventListener('submit', function(event) {
         ...
         socket.emit('fetch-dates', dates );
          ...
          socket.on('return-data', function (args) {
              ...
              const headers = ['pH', 'EC', 'Water Temp', 'Date and Time'];
              ...
              const filename = 'water_quality_info.xlsx';
          ...
          form1.addEventListener('submit', function(event) {
           ...
           socket.emit('fetch-dates1', dates1 );
            ...
            socket.on('return-data1', function(args1) {
                    ...
                    const headers = ['Humidity', 'Room Temperature', 'Date and Time'];
